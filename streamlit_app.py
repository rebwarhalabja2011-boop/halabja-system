...
st.set_page_config(
    page_title="سیستەمی زانیار وارسی شەهیدانی هەڵەبجە",
    page_icon="🏛️",
    layout="centered"
)
...
st.markdown("<h1 class='main-title'>🏛️ بەڕێوەبەرایەتی گشتی کاروباری شەهیدان و ئەنفالکراوانی هەڵەبجە</h1>", unsafe_allow_html=True)
